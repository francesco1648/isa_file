...
module REG1 #(
  parameter int N_BIT = 8  // Numero di bit del registro, valore di default 8
) (
  ...
  input  logic signed [N_BIT - 1 : 0] d_in,   // Dato di input
  output reg signed   [N_BIT - 1 : 0] q_out   // Dato di output
);
