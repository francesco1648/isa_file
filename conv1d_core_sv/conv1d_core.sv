...
S50=50;
  ...
  logic [1:0] SEL_MUX_MEM;

  logic [31:0] CNT_SHIFT_SAMPLE_80;                 //AGGIUNTO N BIT IN PIU PERCHE I SOMMATORI SONO TUTTI SIGNED IN MODO CHE HO RISULTATI CORRETTI
  logic [31:0] CNT_SHIFT_SAMPLE_84;
  logic [31:0] CNT_SHIFT_SAMPLE_BLOCK_8;
  ...
  logic [4:0] CNT_Z;
  //------------------------------------------------------
  logic RESET_CNT_SHIFT_SAMPLE_BLOCK;
  logic EN_CNT_SHIFT_SAMPLE_BLOCK;
  logic TC_SHIFT_SAMPLE_BLOCK;
  logic [2:0] CNT_SHIFT_SAMPLE_BLOCK;

  //-------------------------------------------------------
  logic RESET_CNT_SHIFT_SAMPLE;
  logic EN_CNT_SHIFT_SAMPLE;
  logic TC_SHIFT_SAMPLE;
  logic [2:0] CNT_SHIFT_SAMPLE;
  //------------------------------------------------------
  logic RESET_CNT_CM;
  logic EN_CNT_CM;
  logic TC_CM;
  ...
  logic RESET_SHIFT_ADD;
  logic LR_SHIFT_ADD;
  logic [31:0] REG_SHIFT_ADD;

  logic LR_SHIFT_SAMPLE;
  logic [31:0] REG_SHIFT_SAMPLE0;
  logic [31:0] REG_SHIFT_SAMPLE1;
  logic [31:0] REG_SHIFT_SAMPLE2;
  logic [31:0] REG_SHIFT_SAMPLE3;
  ...
  REG1 #(
      ...
      .clk  (clk),
      .rst_n(rst_n),
      .load (LR_SHIFT_SAMPLE),
      .d_in (data),
      .q_out(REG_SHIFT_SAMPLE0)
  );
  ...
  REG1 #(
      ...
      .rst_n(rst_n),
      .load (LR_SHIFT_SAMPLE),
      .d_in (REG_SHIFT_SAMPLE0),
      .q_out(REG_SHIFT_SAMPLE1)
  );
  ...
  REG1 #(
      ...
      .rst_n(rst_n),
      .load (LR_SHIFT_SAMPLE),
      .d_in (REG_SHIFT_SAMPLE1),
      .q_out(REG_SHIFT_SAMPLE2)
  );
  ...
  REG1 #(
      ...
      .rst_n(rst_n),
      .load (LR_SHIFT_SAMPLE),
      .d_in (REG_SHIFT_SAMPLE2),
      .q_out(REG_SHIFT_SAMPLE3)
  );
  ...
  MUX_4 #(
      ...
      .in0(ADD0_O),
      .in1(ADD2_O),
      .in2(CNT_SHIFT_SAMPLE_BLOCK_8),
      .in3(CNT_SHIFT_SAMPLE_BLOCK_8),
      .y  (ADD4_A)
  );
  ...
  MUX_4 #(
      ...
      .in0(ADD1_O),
      .in1(ADD3_O),
      .in2(CNT_SHIFT_SAMPLE_84),
      .in3(CNT_SHIFT_SAMPLE_80),
      .y  (ADD4_B)
  );
  ...
  COUNTER #(
      .N(3)
  ) COUNTER_SHIFT_SAMPLE_BLOCK (
      .clk           (clk),
      .reset         (RESET_CNT_SHIFT_SAMPLE_BLOCK),
      .enable        (EN_CNT_SHIFT_SAMPLE_BLOCK),
      .terminal_count(TC_SHIFT_SAMPLE_BLOCK),
      .count         (CNT_SHIFT_SAMPLE_BLOCK)
  );
  ...
  COUNTER #(
      .N(3)
  ) COUNTER_SHIFT_SAMPLE (
      .clk           (clk),
      .reset         (RESET_CNT_SHIFT_SAMPLE),
      .enable        (EN_CNT_SHIFT_SAMPLE),
      .terminal_count(TC_SHIFT_SAMPLE),
      .count         (CNT_SHIFT_SAMPLE)
  );
  ...
  assign CNT_SHIFT_SAMPLE_80 = {30'b000000000000000000000000010100, CNT_SHIFT_SAMPLE[1:0]};
  assign CNT_SHIFT_SAMPLE_84 = {30'b0000000000000000000000010101, CNT_SHIFT_SAMPLE[1:0]};
  assign CNT_SHIFT_SAMPLE_BLOCK_8 = {
    27'b0000000000000000000000000, CNT_SHIFT_SAMPLE_BLOCK[1:0], 3'b000
  };
...
TS or MS or CNT_SHIFT_SAMPLE or CNT_SHIFT_SAMPLE_BLOCK) begin
    ...
    case (P_STATE)
      ...
      S34: begin
        if ((CNT_SHIFT_SAMPLE_BLOCK == 3'b100)) begin
          N_STATE = S18;
        end else begin
      ...
      S35: begin
        if ((CNT_SHIFT_SAMPLE == 3'b100)) begin
          N_STATE = S40;
        end else begin
  ...
  always @(P_STATE) begin
    ...
    LR_TS                = 1'b0;
    LR_SHIFT_ADD         = 1'b0;
    LR_SHIFT_SAMPLE      = 1'b0;
    RESET_SHIFT_ADD      = 1'b1;
RESET_CNT_SHIFT_SAMPLE =1'b1;
EN_CNT_SHIFT_SAMPLE = 1'b0;
EN_CNT_SHIFT_SAMPLE_BLOCK =1'b0;
RESET_CNT_SHIFT_SAMPLE_BLOCK=1'b1;

    case (P_STATE)
      IDLE: begin
RESET_CNT_SHIFT_SAMPLE_BLOCK =1'b0;
  RESET_CNT_SHIFT_SAMPLE = 1'b0;
        RESET_SHIFT_ADD      = 1'b0;
        req_i                = 1'b0;
...
add_i[6:0]      = REG_SHIFT_ADD[6:0];
      ...
      S38: begin
        ...
        req_i           = 1'b1;
        ext_mem_gnt     = 1'b0;
        LR_SHIFT_SAMPLE = 1'b1;
        


      end
      S39: begin
        EN_CNT_SHIFT_SAMPLE = 1'b1;
	...
	SEL_MUX_MEM =2'b10;
      ...
      S46: begin
        RESET_CNT_SHIFT_SAMPLE = 1'b0;
        EN_CNT_SHIFT_SAMPLE_BLOCK = 1'b1;
