...
module conv1d_control_reg_top #(
  ...
  logic control_wd;
  logic control_we;
  logic status_runnning_qs;
  logic status_runnning_wd;
  logic status_runnning_we;
  ...
  prim_subreg #(
    ...
    // from register interface
    .we(status_runnning_we),
    .wd(status_runnning_wd),

    // from internal hardware
    .de(hw2reg.status.runnning.de),
    .d (hw2reg.status.runnning.d),

    // to internal hardware
    .qe(),
    .q (reg2hw.status.runnning.q),

    // to register interface (read)
    .qs(status_runnning_qs)
  );
  ...
  assign status_runnning_we = addr_hit[1] & reg_we & !reg_error;
  assign status_runnning_wd = reg_wdata[0];
  ...
  always_comb begin
    ...
    unique case (1'b1)
      ...
      addr_hit[1]: begin
        reg_rdata_next[0] = status_runnning_qs;
